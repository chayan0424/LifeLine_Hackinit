...
class Blood(Tk):      
    ...
    def AP(self, *arg):            
        ...
        type(df)
        df.shape        
        a=df[["HNAME","Distance(in kms)","Location"]][(df["A+"]>15) & (df["Distance(in kms)"]<10) & (df["Review1"]>=3) & (df["Review2"]>=3)]
        #print(a)
        root = tk.Tk()
    ...
    def BP(self, *arg):        
        ...
        type(df)
        df.shape          
        a=df[["HNAME","Distance(in kms)","Location"]][(df["B+"]>15) & (df["Distance(in kms)"]<10) & (df["Review1"]>=3) & (df["Review2"]>=3)]
        #print(a)
        root = tk.Tk()
        T = tk.Text(root, height=40, width=800)
        T.pack()
    ...
    def ABP(self, *arg):             
        ...
        type(df)
        df.shape          
        a=df[["HNAME","Distance(in kms)","Location"]][(df["AB+"]>15) & (df["Distance(in kms)"]<10) & (df["Review1"]>=3) & (df["Review2"]>=3)]
        #print(a)
        root = tk.Tk()
        T = tk.Text(root, height=40, width=800)
        T.pack()
    ...
    def OP(self, *arg):             
        ...
        type(df)
        df.shape          
        a=df[["HNAME","Distance(in kms)","Location"]][(df["O+"]>15) & (df["Distance(in kms)"]<10) & (df["Review1"]>=3) & (df["Review2"]>=3)]
        #print(a)
        root = tk.Tk()
        T = tk.Text(root, height=40, width=800)
        T.pack()
